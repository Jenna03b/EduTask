...
namespace EduTask.Tests.UnitTests.Models
{
    public class UserTests
    {
        ...
        public void Shoud_create_new_user_When_data_is_valid()
        {
            ...
            // act
            var user = new User(email, firstName, lastName, phoneNumber, password, role);
            user.SetRole(role);
        ...
        public void Shoud_throw_exception_When_email_is_invalid()
        {
            ...
            // act & assert
            var ex = Assert.Throws<ArgumentException>(() => new User(email, firstName, lastName, phoneNumber, password, role));
        ...
        public void Shoud_throw_exception_When_password_is_null()
        {
            ...
            // act & assert
            var ex = Assert.Throws<ArgumentException>(() => new User(email, firstName, lastName, "123456789", password, role));
